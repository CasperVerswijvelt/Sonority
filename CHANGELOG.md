...
- Reconfiguring a group that contains a speaker the app can't reach no longer shows that speaker as unticked while saving puts it straight back in — it now shows as part of the group, and can be removed.
