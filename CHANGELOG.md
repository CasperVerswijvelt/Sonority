...
- A profile's pre-flight check no longer lists the same unreachable speaker both as missing and as one it will free — it can't free a speaker it can't resolve.
