...
```
Create the speaker setups the standard app won’t: dedicated fronts, stereo pairs, zones and full surround — then tune it with a 10-band EQ and save it in one tap.
```
