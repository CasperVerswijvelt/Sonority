...
/// `_sfSymbolNames` (SF-symbol names for the native shortcut + widget). Adding
/// an icon to one but forgetting another silently falls back to a default glyph
/// — this catches it.
void main() {
  test('profile icon maps share identical key sets', () {
    ...
    expect(sfSymbolNameKeys, material);
  });
}
